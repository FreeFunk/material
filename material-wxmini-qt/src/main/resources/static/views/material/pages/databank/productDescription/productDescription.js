...
Page({
    ...
    selectData: function () {
        ...
        commservice.generatePageObj(productObj, app.globalData.appHost + '/materialProductIntroduction/listpage.jsn', 200);
        productObj.param = {
    ...
    previewImg: function (event) {
        ...
        for (var i = 0; i < this.data.productImgList.length; i++) {
            previewImgList.push(getApp().globalData.imageHost + this.data.productImgList[i].fileUrl);
        }
