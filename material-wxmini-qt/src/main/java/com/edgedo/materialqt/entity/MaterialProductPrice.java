...
@TableName("material_product_price")
public class MaterialProductPrice implements Serializable{
	 ...
	 * 属性描述:产品报价名
	 */
	@TableField(value="PRODUCT_PRICE_NAME",exist=true)
	java.lang.String productPriceName;
	...
	public String getCaseMiniImg() {
		return caseMiniImg;
	}

	public void setCaseMiniImg(String caseMiniImg) {
	...
	public java.lang.String getProductPriceName(){
		return this.productPriceName;
	}
	
	public void setProductPriceName(java.lang.String productPriceName){
    ...
    public String toString() {
        ...
        sb.append("Hash = ").append(hashCode());
			...
			sb.append(", productPriceName=").append(productPriceName);			
    ...
    public boolean equals(Object that) {
        ...
        MaterialProductPrice other = (MaterialProductPrice) that;
        boolean flag = true;
        return  flag
        		&&(this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))		
				        		...
				        		&&(this.getProductPriceName() == null ? other.getId() == null : this.getProductPriceName().equals(other.getProductPriceName()))		
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getId() == null) ? 0 : getId().hashCode());		
		        ...
		        result = prime * result + ((getProductPriceName() == null) ? 0 : getProductPriceName().hashCode());		
