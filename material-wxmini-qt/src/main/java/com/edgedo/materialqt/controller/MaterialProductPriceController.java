...
import com.edgedo.materialqt.service.MaterialProductPriceService;
...
@Controller
@RequestMapping("/materialProductPrice")
public class MaterialProductPriceController extends BaseController{
	...
	public ModelAndView saveOrUpdate(MaterialProductPrice voObj){
		ModelAndView modelAndView = new ModelAndView();
		String errMsg = "";
