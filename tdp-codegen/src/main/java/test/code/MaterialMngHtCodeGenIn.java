...
public class MaterialMngHtCodeGenIn {
	
	public static void main(String[] args) throws Exception {
		//TODO:表名
		String tableName = "material_config";
		//TODO:项目文件夹
		String projectDir = "material-mng-ht";
		//TODO:mapper文件夹
		String mapperDir = "material";
		//TODO:模块包路径
		String modelpackage = "com.edgedo.material";
		//TODO:前端的包路径
		String packageName = "material.materialconfig";
		//TODO:访问url前缀
		String urlprefix = "/";
		//TODO:生成代码连接数据库
		...
		String path = MaterialMngHtCodeGenIn.class.getProtectionDomain().getCodeSource().getLocation().getFile();
