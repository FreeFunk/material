...
public class MaterialWxMiniQtCodeGenIn {
	
	public static void main(String[] args) throws Exception {
		//TODO:表名
		String tableName = "material_product_style";
		//TODO:项目文件夹
		String projectDir = "material-wxmini-qt";
		//TODO:mapper文件夹
		String mapperDir = "materialqt";
		//TODO:模块包路径
		String modelpackage = "com.edgedo.materialqt";
		//TODO:前端的包路径
		String packageName = "material.xxx";
		//TODO:访问url前缀
		String urlprefix = "/";
		//TODO:生成代码连接数据库
		...
		String path = MaterialWxMiniQtCodeGenIn.class.getProtectionDomain().getCodeSource().getLocation().getFile();
