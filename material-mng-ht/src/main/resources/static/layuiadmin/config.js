...
/*    ,basePath:'http://localhost:8200'
    ,pageHost:'http://localhost:8200'*/
    ,basePath:'https://m.yiwei-fs.com:9001'
    ,pageHost:'https://m.yiwei-fs.com:9001'
    ,ImgPath:'https://m.yiwei-fs.com:9004'
    ,views: layui.cache.base + 'tpl/' //动态模板所在目录
    ,entry: 'index' //默认视图文件名
    ,imageTxt: '/server/app/material/material-res' //视图文件后缀名
    ,engine: '.html' //视图文件后缀名
    ,pageTabs: true //是否开启页面选项卡功能。iframe版推荐开启
    
    ,name: 'layuiAdmin'
    ,tableName: 'layuiAdmin' //本地存储表名
    ,MOD_NAME: 'admin' //模块事件名compressImg
    ...
    ,bMap:{
        ak:'y0M3smRm6FRmGRYH2VT0mXLC6M4mhgPt'//必须参数，其余参数可不配置
