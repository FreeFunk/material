...
public class MaterialCase implements Serializable{
	 ...
	 * 属性描述:发现页排序号
	 */
	@TableField(value="FIND_ORDER_NUM",exist=true)
	java.math.BigDecimal findOrderNum;
	...
	public BigDecimal getFindOrderNum() {
		return findOrderNum;
	}

	public void setFindOrderNum(BigDecimal findOrderNum) {
		this.findOrderNum = findOrderNum;
	}
